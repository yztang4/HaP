        ...
        for data in trainloader: 
            ...
            if task in ['refine_completion', 'denoise']:
                if task == 'refine_completion':
                    ...
                    predict_normal  = net(generated, condition, ts=None, label=None)
                ...
                # cdloss, normalloss = calc_cd_normal(generated, generated, X, predict_normal)
                loss = 1-cos(X,predict_normal).mean()
