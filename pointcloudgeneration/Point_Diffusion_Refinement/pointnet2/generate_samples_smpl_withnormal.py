...
# from models.pointnet2_with_pcld_condition_withoutnormal import PointNet2CloudCondition
...
from completion_eval_smpl_withnormal import evaluate
...
def main(config_file, pointnet_config, trainset_config, train_config, diffusion_config, diffusion_hyperparams, 
    ...
    assert dataset in ['shapenet', 'refine_thuman_dataset', 'smpl_thuman_dataset', 'shapenet_chunk', 'mvp40', 'partnet']
    ...
    elif dataset == 'smpl_thuman_dataset':
        save_dir = 'mvp_dataloader/data/smpl_thuman_dataset/generated_samples'
    elif dataset == 'refine_thuman_dataset':
        save_dir = 'mvp_dataloader/data/refine_thuman_dataset/generated_samples'
    elif dataset == 'mvp40':
    ...
    if (dataset=='smpl_thuman_dataset' and phase == 'test_trainset') or (dataset=='shapenet_chunk' and phase=='test'):
...
if __name__ == "__main__":
    ...
    elif train_config['dataset'] == 'smpl_thuman_dataset':
