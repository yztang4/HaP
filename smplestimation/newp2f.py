...
def point_mesh_face_distance(
    ...
    faces_packed = faces_packed[visible_face,...]
    faces_packed = faces_packed.cuda()
    ...
    weights_t = weights_t[visible_face]
    weights_t = weights_t.cuda()
...
def point_mesh_face_distance_ori(
    meshes: Meshes,
    pcls: Pointclouds,
    min_triangle_area: float = _DEFAULT_MIN_TRIANGLE_AREA,
):
